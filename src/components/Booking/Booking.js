...
function Booking() {
	...
	const bookEvents = [
		{
			title: 'Group Bookings at Lagos Bistro',
			desc: 'Perfect for your corporate dining or personal celebration from 12 to 50 guests. For groups of 12 up to a maximum of 50 guests, a three course menu, four dishes per course, derived from the current a la carte menu is applicable. The three course menu is priced from N10,000 per person. A N12,000 per person minimum spend is required for all group lunch or dinner bookings.',
			imgUrl: '/lagosbistro/img6.jpg',
			blurUrl: '/lagosbistro/img6.jpg',
		},
		{
			title: 'Private Dining Experience',
			desc: 'Book an impressive private space with us this season. Whether a corporate group seeking privacy or a carefree lunch with friends and family, Lagos Bistro Private Dining is one of the most prized locations for a seated dinner or evening cocktail gathering. With your own highly skilled and personable waiter for the room, we can guarantee your function will be a memorable success.',
			imgUrl: '/lagosbistro/img8.jpg',
			blurUrl: '/lagosbistro/img8.jpg',
		},
		{
			title: 'We Offer Exclusive Use',
			desc: 'From high profile celebrations to business lunches, Lagos Bistro caters for some of the country’s most exclusive private functions. With a spacious terrace that provides the most impressive backdrop for guests and has appealed to iconic brands, corporates, celebrities, media and magazines alike.',
			imgUrl: '/lagosbistro/img12.jpg',
			blurUrl: '/lagosbistro/img12.jpg',
		},
	];
